...
public class ProfissionalResource {
	...
	@PostMapping
	public ResponseEntity<ProfissionalModel> insert(@RequestBody ProfissionalModel obj){
	...
	@PutMapping(value= "/{id}")
	public ResponseEntity<ProfissionalModel> update(@PathVariable Long id, @RequestBody ProfissionalModel obj){
